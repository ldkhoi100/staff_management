...
class BacLuongController extends Controller
{
    ...
    public function __construct(BacLuongService $factorSalaryService)
    {
        ...
        $this->middleware('role:ROLE_ADMIN|ROLE_SUPERADMIN')->except(['create', 'delete','restore', 'moveToTrash']);
        $this->middleware('role:ROLE_SUPERADMIN')->only(['create', 'delete','restore', 'moveToTrash']);
